...
public class ReturnVO implements Serializable {
    private static long serivalVerSionUID = 9120765714832970813L;
    private static final Properties properties = ReadPropertiesUtil.getProperties(
            "D:/use_space/project_sapce/spring/study/web/dem1/src/main/resources/response.properties");
